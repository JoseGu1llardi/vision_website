        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="text-foreground/80 leading-relaxed space-y-6 text-lg">
            ...
            <p>
              ...
              , we have proudly evolved into a full-service partner for your
            ...
            <p>
              ...
              sophisticated water features and complete property
              transformations, we bring the same precision and care to building
              your dream landscape as we always have to maintaining it.
            </p>
