      ...
      <div className="container mx-auto max-w-4xl">
        <div className="flex flex-col items-center gap-5 text-center">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <div className="w-10 h-10 flex items-center justify-center rounded-full border-2 border-foreground/20 group-hover:border-[#237c20] transition-all duration-300 group-hover:scale-105">
                <svg
                  className="w-4 h-4 text-foreground/60 group-hover:text-[#237c20] transition-colors"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <span className="text-[10px] tracking-wider text-foreground/50 group-hover:text-[#237c20] transition-colors">
                Instagram
              </span>
            </a>
